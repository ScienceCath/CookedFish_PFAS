...
fishdata <- read_sheet("https://docs.google.com/spreadsheets/d/1cbmYDfIc2dxHJxBaowojUZZkN31NW4sL_pHw0t9eTTU/edit#gid=477880397", range = "Data_extraction_2", skip=1, col_types = "ccnccccccncncccccnncccnnccnncncnccnnncncncccccccc") #with specifying column types
dim(fishdata)
#610  48
names(fishdata)
#View(fishdata)
