...
fishdata <- read_sheet("https://docs.google.com/spreadsheets/d/1cbmYDfIc2dxHJxBaowojUZZkN31NW4sL_pHw0t9eTTU/edit#gid=477880397", range = "Data_extraction_2", skip=1, col_types = "ccnccccccncncccccnncccnccnncncnccnnncncncccccccc") #with specifying column types
dim(fishdata)
#610  48
names(fishdata)
#View(fishdata)
...
mean(volume$Volume_liquid_ml)

range(volume$Volume_liquid_ml)
