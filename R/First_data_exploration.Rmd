...
table(is.na(fishdata$Sc)) #53 missing values --> correct!
table(is.na(fishdata$Se)) #55 missing values --> correct!

table(is.na(fishdata$Nc)) #0 missing values
table(is.na(fishdata$Ne)) #0 missing values

table(is.na(fishdata$PFAS_carbon_chain)) #0 missing values
