...
write.csv(fishdata_3, here("data", "Rawdata.csv"), row.names = F)

fishdata_3 <- read.csv(here("data", "Rawdata.csv"))
...
####Liquid volume tissue sample ratio
```{r echo=FALSE, message=FALSE, warning=FALSE}
...
mean(ratio_2$Ratio_liquid_fish)
#13.5824
