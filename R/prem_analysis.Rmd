...
```{r, fig.width=10, fig.height=7}
res_volume<-marginal_means(full_model_org_units_oil_water, data = dat, mod = "1", at = list(log_Volume_liquid_ml= c(2.3, 5.5, 9.2)), by = "log_Volume_liquid_ml")
...
```{r, fig.height=5, fig.width=7}
volume_mm <-marginal_means(full_model_org_units_oil_water, data = dat, mod = "1", at = list(log_Volume_liquid_ml= c(2.3, 6.2, 9.2)), by = "log_Volume_liquid_ml")
