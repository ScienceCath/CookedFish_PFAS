...
test <-marginal_means(full_model_org_units, data = dat, mod = "Cooking_Category", at = list(Length_cooking_time_in_s = c(100, 600, 1200)), by = "Length_cooking_time_in_s")
 
 orchard_plot(test, xlab = "lnRR", mod = "Cooking_Category")
