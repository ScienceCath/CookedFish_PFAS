...
ggplot(dat,aes(x = Length_cooking_time_in_s, y = lnRR, fill=Cooking_Category)) +
       ...
       geom_ribbon(data=water_dat_time, aes(ymin = ci.lb, ymax = ci.ub, color = NULL), alpha = 0.1) +
...
## Subset analysis without Study_ID F005 
```{r, fig.width=9, fig.height=7}
...
plot_continuous(dat.sens.vol, mod.sens.vol, log(dat.sens.vol$Volume_liquid_ml), "Volume (s)") # The relationship with cooking time appears even stronger
