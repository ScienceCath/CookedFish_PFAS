...
plot_continuous(dat.volume, volume_model, log(dat.volume$Ratio_liquid_fish), "ln (Tissue to liquid volume ratio)")
```
...
Overall mean at the mean of each other predictor
```{r}
...
plot_continuous(dat.sens.vol, mod.sens.vol, log(dat.sens.vol$Ratio_liquid_fish), "ln(Liquid volume to tissue sample ratio (mL/g))") +
  scale_fill_manual(values=c("goldenrod2", "dodgerblue3"))# The relationship with cooking time appears even stronger 
