...
```{r load-pilot-data, echo=FALSE, eval=FALSE}
...
# saving data
saveRDS(fishdata,here("data","fishdata.rds"))
```

```{r}
fishdata <- load(here("data","fishdata.rds"))
```
...
write.csv(fishdata_2, here("data","pilot_data_preprocessed.csv"))

fishdata_2 <- read.csv( here("data","pilot_data_preprocessed.csv"))
```
