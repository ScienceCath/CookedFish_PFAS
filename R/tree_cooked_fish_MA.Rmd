...
*NOTE:* Scomber scombrus appears twice but with one or two spaces in between the words! - fix in the original file!
...
intersect(tree2$tip.label, taxa2$unique_name) #39
...
intersect(myspecies, tree2$tip.label) #35
...
intersect(myspecies, tree2$tip.label) #39
