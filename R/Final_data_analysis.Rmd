...
```{r, fig.width=10, fig.height=7}
res_volume0<-marginal_means(full_model_org_units0, data = dat, mod = "1", at = list(log_Ratio_liquid_fish0 = c(0, log(10), log(45))), by = "log_Ratio_liquid_fish0")
...
mod.sens.vol0<- rma.mv(lnRR, VCV_lnRR.sens.vol, 
...
plot_continuous(dat.sens.vol0, mod.sens.vol0, log(dat.sens.vol$Ratio_liquid_fish_0 + 1), "ln(Liquid volume to tissue sample ratio + 1 (mL/g))") +
  scale_fill_manual(values=c("#55C667FF","goldenrod2", "dodgerblue3"))
