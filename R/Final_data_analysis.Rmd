...
```{r, fig.width=10, fig.height=7}
res_dry<-mod_results(full_model_org_units_dry, data = dat, group="Study_ID", mod = "1")
res_dry$mod_table
...
```{r, fig.width=10, fig.height=7}
res_cooking_time_dry <-mod_results(full_model_org_units_dry, data = dat, group="Study_ID",at = list(Length_cooking_time_in_s = c(120,600,1500)), by = "Length_cooking_time_in_s")
