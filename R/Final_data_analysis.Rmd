...
write.csv(processed_data, here("data", "Rawdata_updated_2.csv"), row.names = F)
```
...
# plot 
# TODO - Patrice - you may need to change several arguments with orchard plot!
orchard_plot(MA_model, mod = "1", xlab = "lnRR", alpha=0.4, data = dat, group = "Study_ID") +  # Orchard plot 
